...
$string['hotspots'] = 'Hotspotovi';
$string['hotspot_add'] = 'Dodaj hotspot';
$string['hotspot_title'] = 'Naslov';
$string['hotspot_content'] = 'Sadržaj';
$string['hotspot_position'] = 'Pozicija';
$string['hotspot_delete'] = 'Obriši hotspot';
$string['hotspot_delete_confirm'] = 'Da li ste sigurni da želite da obrišete ovaj hotspot?';
